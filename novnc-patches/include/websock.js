...
function Websock() {
    ...
    this._rQmax = 2000;      // Max receive queue size before compacting (reduced for iOS 9)
    this._sQ = [];           // Send queue
    ...
    Websock.prototype = {
        ...
        _recv_message: function (e) {
            try {
                ...
                if (this.rQlen() > 0) {
                    // Track WebSocket buffer usage for debugging
                    if (window.MemDebug) { window.MemDebug.updateWSBufferSize(this._rQ.length, this._rQi); }
