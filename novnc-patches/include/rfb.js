...
(function () {
    ...
    RFB = function (defaults) {
        ...
        // Pre-bound functions to avoid closure leaks
        this._boundHandleMessage = null;
        this._boundDisconnectTimeout = null;
        ...
        // Initialize bound functions to prevent closure leaks
        this._boundHandleMessage = function () {
            this._msgTimer = null;
            this._handle_message();
        }.bind(this);

        this._boundDisconnectTimeout = function () {
    ...
    RFB.prototype = {
        ...
        _updateState: function (state, statusMsg) {
            ...
            switch (state) {
                ...
                case 'disconnect':
                    // Use pre-bound function to avoid creating new closures
                    this._disconnTimer = setTimeout(this._boundDisconnectTimeout, this._disconnectTimeout * 1000);
                ...
                case 'normal':
                    if (this._normal_msg() && this._sock.rQlen() > 0) {
                        ...
                        if (this._msgTimer === null) {
                            ...
                            // Use pre-bound function to avoid creating new closures
                            this._msgTimer = setTimeout(this._boundHandleMessage, 10);
                        } else {
